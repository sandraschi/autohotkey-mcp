                    ...
                    with Card():
                        with CardContent():
                            with Column(gap=1):
                                Muted("Bridge")
                                if bridge_up:
                                    Badge("UP", variant="success")
                                else:
                                    Badge("DOWN", variant="destructive")
                    ...
                    with Card():
                        with CardContent():
                            with Column(gap=1):
                                Muted("AHK Exe")
                                if ahk_found:
                                    Badge("found", variant="success")
                                else:
                                    Badge("missing", variant="destructive")
            # Config table
            with Card(css_class="w-full"):
                with CardHeader():
