...
const BACKEND_NAME: &str = "autohotkey-mcp-backend.exe";
const BACKEND_PORT: u16 = 10746;
const BACKEND_TAG: &str = "autohotkey-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "AUTOHOTKEY_MCP_PORT";
const ENV_HOST: &str = "AUTOHOTKEY_MCP_HOST";
const ENV_TAURI: &str = "AUTOHOTKEY_MCP_TAURI";
